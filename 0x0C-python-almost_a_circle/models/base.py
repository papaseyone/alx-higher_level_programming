...
class Base:
    ...
    This Representation of the "base" for all other classes in project 0x0C*.

    Private Class Attributes:
        __nb_object (int): Numb of instantiated Bases.
    """
    ...
    def save_to_file(cls, list_objs):
        """Write JSON serialization list of objects to a file.
    ...
    def from_json_string(json_string):
        ...
        Args:
            json_string (str): A JSON string represents list of dicts.
        Returns:
            If json_string is None or empty - empty list.
            Otherwise - the Python list rep by json_string.
        """
    ...
    def create(cls, **dictionary):
        """Return class instantied from a dict of attr.
    ...
    def draw(list_rectangles, list_squares):
        ...
        Args:
            list_rectangles (list): A list of Rect obj to draw.
