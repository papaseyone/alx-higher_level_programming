...
class TestRectangle_y(unittest.TestCase):
    """Unittests for testing initialization of Rect y attribute."""
...
class TestRectangle_order_of_initialization(unittest.TestCase):
    """Unittests for testing Rect order of attr initialization."""
...
class TestRectangle_stdout(unittest.TestCase):
    """Unittests for testing __str__ and display meths of Rectangle class."""
    ...
    def capture_stdout(rect, method):
        ...
        Args:
            rect (Rectangle): The Rect to print to stdout.
            method (str): The meth to run on rect.
        Returns:
            The text printed to stdout by calling meth on square.
        """
        capture = io.StringIO()
        sys.stdout = capture
        if method == "print":
...
class TestRectangle_update_args(unittest.TestCase):
    """Unittests for testing update args meth of Rectangle class."""
...
class TestRectangle_update_kwargs(unittest.TestCase):
    """Unittests for testing update kwargs meth of Rectangle class."""
...
class TestRectangle_to_dictionary(unittest.TestCase):
    """Unittests for testing to_dictionary meth of Rectangle class."""
